...
def searchSpotDetails(parkingData,blockID):
...
def __main__():
    ...
    #print(parkingSearch(37.806054,-122.410329,'2012-05-05 23:40:13','baseline'))
    
    print(parkingSearch(37.808245,-122.415816,'2012-05-05 23:40:13',1))
